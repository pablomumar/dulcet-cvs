...
get_header(); ?>
    ...
    <div class="eventi-content-all">
        <!-- Title -->
        <div class="eventi-cabecera">
            <h1>
                <strong>
                    Ci immergiamo a 360° negli eventi, per essere coinvolti in prima persona e fare la differenza
                </strong>
            </h1>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
        ...
        <div class="eventi-cont">
            ...
            <div class="eventi-list row">
                <div class="eventi-cont-img col-md-6 col-sm-6 col-xs-12" style="float: right">
                    <img src="<?php echo get_template_directory_uri();?>/images/eventi-1.jpg" alt="" class="eventi-img">
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="eventi-cont-text">
                    <p><strong>Event Design e Location Management</strong></p>
                    </div>
                </div>
            </div>
